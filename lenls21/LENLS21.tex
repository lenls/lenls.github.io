...
\begin{Large}
{\em hosted by \\\ \\ AI systems that can explain by language based on knowledge and reasoning}
\end{Large}
...
LENLS is being organized by an alliance of "AI systems that can explain by language based on knowledge and reasoning" project (Grant Number JPMJCR20D2), funded by JST CREST Programs "Core technologies for trusted quality AI systems."  LENLS 20 is co-organized by Nagoya University.
