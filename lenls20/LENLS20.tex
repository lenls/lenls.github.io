...
\begin{large}
\begin{center}
Hybrid (Osaka University Nakanoshima Center | Online), \\
...
\item[$\maltese$] Nonclassical logic and its relation to natural language (e.g. substructural, fuzzy, categorical, and topological logic)
